...
class AW_Raf_Block_Adminhtml_System_Configuration_Button extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    ...
    protected function _getElementHtml(Varien_Data_Form_Element_Abstract $element)
    {
        ...
        $url = $this->getUrl("awraf_admin/adminhtml_rules/resetAll", array('awraf' => $helper->encodeUrlKey($secret)));
        
        Mage::getSingleton('adminhtml/session')->setAwrafResetSecret($secret);
